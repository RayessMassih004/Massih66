...
def notice():
	...
	runtxt("\033[0;92m ADMIN Massihjan")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Massihjan/KEY/blob/main/key.txt').text
			if basesplit in plr:
				key = basesplit
...
█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
█  Github:https://github.com/Massihjan
█  Telegram : KingMassihjan
